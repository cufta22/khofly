  ...
  return (
    <Container size="lg" py={80}>
      <Card p="xl">
        ...
        <Text>
          Cookies are used only to store user preferrences like selected language, color scheme of
          the app, etc. No personal data is stored and no 3rd party tracking cookies are ever used.
          You can check this in DevTools ( Ctrl + Shift + I ) and go into Application ( for Chrome )
        ...
        <Text mt="md">
          ...
          further you can also self-host Khofly itself. Guides for self-hosting can be found either
