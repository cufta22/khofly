...
export const KEYWORDS_UNITS_LENGTH = ['m', 'mm', 'cm', 'dm', 'km', 'in', 'ft', 'yd', 'mi'];

export const KEYWORDS_UNITS_AREA = ['m2', 'ares', 'acre', 'ha', 'in2', 'ft2', 'yd2', 'mi2'];
...
export const KEYWORDS_UNITS_MASS = ['g', 'kg', 'gr', 'dr', 'oz', 'lb', 'cwt', 'ton', 't', 'slug'];
