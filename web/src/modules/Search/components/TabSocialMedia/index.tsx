...
const TabSocialMedia = () => {
  ...
  const { data, error, isLoading, isValidating, size, setSize, mutate } = useSearXNGSWR<ISearXNGResultsSocialMedia>();
  ...
  return (
    <Flex className={classes.tab_social_media} align="flex-start">
      {/* Search results */}
      <Stack className={classes.stack} py="xl">
        ...
        {(isLoading || isValidating) &&
          // Loading state
          Array.from(Array(10).keys()).map((e, i) => <SocialMediaSkeleton key={i} />)}
