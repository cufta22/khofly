...
const Docs3rdPartyWeather = () => {
  ...
  return (
    <Container size="lg" p="xl" pb={100}>
      ...
      <DocsText>
        OpenWeatherMap One Call API is used to fetch data server side. One Call
        API requires an API key to be used so if you want to self host the
        Khofly API you'll need to go to{" "}
        <DocsLink
      ...
      <DocsText>
        One Call API is "pay as you call" but you still get 1000 free requests
        per day and you can set a limit to how many requests are allowed in the
        dashboard so you can ensure that you don't go over the 1000 requests if
