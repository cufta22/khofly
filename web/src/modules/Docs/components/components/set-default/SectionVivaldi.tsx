...
const SectionVivaldi = () => {
  return (
    <>
      ...
      <DocsText>
        You can add engines as well as edit, modify and manage all of your search settings. To do
        this, add them through preferences in Vivaldi Settings/Search. Here, you can modify and
        organize to your own preferences. With a little bit of magic, you can now start searching
        with your new custom search engine. Use the URLs below to add search engines from a few of
        our favourite sites.
      </DocsText>

      <DocsText>
        Example how to add Khofly <Code>https://khofly.com/search?q=%s&tab=general</Code>
      </DocsText>
