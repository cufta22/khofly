...
const SectionEdge = () => {
  return (
    <>
      <DocsText>
        1. Perform a search in the address bar using the search engine you want to set as your
        default.
      </DocsText>

      <DocsText>
        2. Select <b>Settings and more</b>{' '}
        <IconDots style={getIconStyle(18, true)} display='inline-block' /> and then <b>Settings</b>{' '}
      ...
      <DocsText>
        5. Choose your preferred search engine from the <b>Search engine used in the address bar</b>{' '}
        menu.
      </DocsText>
