  ...
  return (
    <>
      ...
      <DocsText>
        ...
        <DocsLink href='https://developer.mozilla.org/docs/Web/OpenSearch' label='OpenSearch' />{' '}
      ...
      <DocsText>The search engine will appear in your available search options.</DocsText>
      ...
      <DocsText>
        ...
        <DocsLink href='https://developer.mozilla.org/docs/Web/OpenSearch' label='OpenSearch' />{' '}
        search engine, you can add it from the address bar context menu (we&apos;ll use{' '}
        <DocsLink href='https://youtube.com' label='YouTube' /> as an example).
      </DocsText>
      ...
      <DocsText>2. Select Add &quot;YouTube&quot; from the context menu. </DocsText>
