...
import { IconDotsVertical, IconInfoCircle, IconPencil } from '@tabler/icons-react';
  ...
  return (
    <>
      <DocsText>
        ...
        <IconDotsVertical style={getIconStyle(18, true)} display='inline-block' /> and then{' '}
        <b>Settings</b>.
      </DocsText>
      ...
      <List mt='xs'>
        <List.Item>
          <b>Add:</b> To the right of &apos;Site search,&apos; click <b>Add</b>. After you fill out
          the text fields, click <b>Add</b>.
        </List.Item>
        ...
        <List.Item>
          <b>Set as default:</b> To the right of a site search shortcut, click More{' '}
          <IconDotsVertical style={getIconStyle(18, true)} display='inline-block' /> and then{' '}
          <b>Make default</b>.
        </List.Item>
        ...
        <List.Item>
          ...
          <IconDotsVertical style={getIconStyle(18, true)} display='inline-block' />
          and then <b>Delete</b>.
        </List.Item>
      </List>
      ...
      <Alert mt='xl' variant='light' color='blue' title='Learn more' icon={<IconInfoCircle />}>
        ...
        <DocsLink href='https://support.google.com/chrome/answer/95426' label='official docs' />.
      </Alert>
    </>
  );
};
