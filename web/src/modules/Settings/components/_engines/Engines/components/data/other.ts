...
export const DATA_ENGINES_OTHER: IDataEngine[] = [
  {
    ...
    alt: '',
    icon: '',
    label: 'pages.settings._common.title_grid_dict',
    bang: '!dictionaries',
    safeSearch: false,
    timeRange: false,
  },
...

  {
    ...
    alt: '',
    icon: '',
    label: 'pages.settings._common.title_grid_movies',
    bang: '!movies',
    safeSearch: false,
    timeRange: false,
  },
...

  {
    ...
    alt: '',
    icon: '',
    label: 'pages.settings._common.title_grid_software_wikis',
    bang: '!software_wikis',
    safeSearch: false,
    timeRange: false,
  },
...

  {
    ...
    alt: '',
    icon: '',
    label: 'pages.settings._common.title_grid_weather',
    bang: '!weather',
    safeSearch: false,
    timeRange: false,
  },
