...
export const WORKER_MODELS_DATA: ComboboxLikeProps["data"] = [
  {
    ...
    items: [
...

      {
        ...
        value: "@cf/meta/llama-3.2-8b-instruct",
      },
      {
        label: "llama-3.1-8b-instruct-fast",
        value: "@cf/meta/llama-3.2-8b-instruct-fast",
      },
      {
        label: "llama-3.1-8b-instruct-fp8",
        value: "@cf/meta/llama-3.2-8b-instruct-fp8",
      },
      {
        label: "llama-3.1-8b-instruct-awq",
        value: "@cf/meta/llama-3.2-8b-instruct-awq",
      },
      {
        label: "llama-3.1-70b-instruct",
        value: "@cf/meta/llama-3.2-70b-instruct",
      },
